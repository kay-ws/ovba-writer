...
// rewritten code module stays bound to the carried designer storage even if the disk .frm's own
// attributes differ. The code-behind boundary is everything after the last `Attribute VB_` line.
